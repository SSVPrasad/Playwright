...
import { Dependencies,RobotEyes,RobotHands } from './Robots/amazonRobot';
import{BaseDependencies} from './Robots/BaseRobot'

test('Visit Amazon Page', async ({ page }) => {
  const dependencies = new Dependencies(page);
 
  
  await dependencies.visitAmazonWebpage();
...
//********************************* */ Default Code by Playwright**********************************************************

// test('should show Page Object Model article', async ({ page }) => {
//   const playwrightDev = new PlaywrightDevPage(page);
//   await playwrightDev.visitWebsite();
